...
impl Location for crate::hl::file::File {
    fn name(&self) -> &str { "/" }
    fn attr_names(&self) -> crate::Result<Vec<String>> { self.attr_names() }
    fn attr(&self, name: &str) -> crate::Result<crate::hl::attribute::Attribute> { self.attr(name) }
}
